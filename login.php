            ...
            <section class="form login">
                  ...
                  <form action="#">
                        ...
                        <div id="l-email" class="mb-3 ml-3 field input">
                              ...
                              <div class="row">
                                    <input type="text" name="email_account" class="form-control ml-5 mt-2 col-5"
                                          id="l-email" placeholder="輸入信箱或帳號">
                        ...
                        <div id="l-password" class="mb-3 ml-3 field input">
                              ...
                              <div class="row">
                                    <input type="password" name="password" class="form-control ml-5 mt-2 col-5"
                                          id="l-password" placeholder="輸入密碼">
                                    <i class="fa fa-eye col-2 mt-3"></i>
                              </div>
                        </div>
                        <hr class="hr">
                        <div id="l-login-l" class="row ml-4 mb-3 field button">
                              <input type="submit" id="l-login-l" class="btn btn-outline-warning ml-5 col-3 btn-lg"
                                    value="會員登入" />
                              <button onclick="location.href ='<?php echo $client->createAuthUrl() ?>'"
                                    class="btn btn-outline-primary btn-lg ml-5 col-3"><i class="bi bi-google"></i>Google
                                    Login</button>
