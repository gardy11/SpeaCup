                  ...
                  <form action="#" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div id="r-account" class="m-3">
                              <div class="row">
                                    ...
                                    <span id="passwordHelpInline"
                                          class="form-text mt-2 pr-5 col-6 text-muted">&ensp;帳號長度為大小寫英數字8-20字。</span>
                              </div>
                        ...
                        <div id="r-password" class="m-3 field input">
                              <div class="row">
                                    ...
                                    <span id="passwordHelpInline"
                                          class="form-text mt-2 pr-5 col-6 text-muted">&ensp;密碼長度為大小寫英數字8-20字。</span>
                              </div>
                              <div class="col-auto row field input">
                                    <input type="password" name="password" id="inputPassword6"
                                          class="form-control ml-5 " placeholder="輸入密碼"
                        ...
                        <div class="name-details">
                              <div class="m-3 field input">
                                    <h4 class="ml-5 ">暱稱:</h4>
                                    <input type="text" name="fname" class="form-control ml-5" placeholder="請輸入暱稱"
                        ...
                        <div class="gender m-3 mt-2">
                              <h4 class="ml-5 ">性別:</4>
                                    <input id="g1" type="radio" name="gender" value="男" checked="checked"
                                          required /><label for="g1">男</label>
                                    <input id="g2" type="radio" name="gender" value="女" required /><label
                                          for="g2">女</label>
                        </div>
                        ...
                        <div id="r-register" class="m-3 pl-5 field button row">
                              <input type="submit" id="l-login-l" class="btn btn-outline-warning ml-5 col-3"
                                    value="會員註冊" />
