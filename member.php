...
<body class="body">
      ...
      <div id="siderbarleft">
            <ul class="nav flex-column ind ">
                  ...
                  <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="member.php"><i
                                    class="fa-solid fa-bell">&ensp;基本資料</i></a>
                  </li>
                  <li class="nav-item">
            ...
            <section class="form update">
                  <form method="POST" action="#" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div id="m-nickname" class="m-3 field input">
                              ...
                              <input type="text" name="fname" value="<?php echo $row['nickname']; ?>" id="m-nickname-n"
                                    class="ml-5" required />
                        ...
                        <div id="m-password" class="m-3">
                              ...
                              <div class="row ">
                                    <button class="btn btn-outline-warning ml-5 col-2"
                                          onclick="location.href='update_pw.php'">更改密碼</button>
                              ...
                              <div class="row">
                                    ...
                                    <div class="col" style="padding-left:10%">
                                          <div class="input-group mb-1 pb-5 col-7 field image" width="200px">
                                                <img id="preview_img" src="php/images/review.png" width="200px"
                                                      height="200px" style="padding-bottom:2%" />
                                                <input type="file" name="image" accept="image/*,.jpeg, .png, .jpg"
                                                      class="form-control " id="inputGroupFile02" width="200px">
                                          </div>
                                    </div>
                        ...
                        <div id="m-bd" class="m-3">
                              ...
                              <div id="r-bd-r" class="ml-5 field" style="display:none">
                                    <input type="date" name="birth" id="r-bd" value="<?php echo $row['birth'] ?>"
                                          required />
                              </div>
                              <?php } else { ?>
                              <!-- 限制日期只可選取不可自行輸入 -->
                        ...
                        <div id="m-bd" class="m-3 mt-2">
                              ...
                              <div class="gender m-3 mt-2" style="display:none">
                                    <input id="g1" type="radio" name="gender" value="男" class="ml-5" required /><label
                                          for="g1">男</label>
                                    <input id="g2" type="radio" name="gender" value="女" class="ml-5" required /><label
                                          for="g2">女</label>
                                    <!-- 未勾選按鈕的情況下 回傳預設值 -->
                        ...
                        <div id="m-email" class="m-3 field input">
                              ...
                              <!-- 傳回預設值以讓後端更新-->
                              <input type="email" name="email" value="<?php echo $row['email']; ?>" id="m-email-e"
                                    class="ml-5 " readonly required />
                        ...
                        <div id="m-c" class="m-3 field button">
                              <input type="submit" name="submit2" class="btn btn-outline-warning  m-3 ml-5 mb-5"
                                    value="儲存修改">
                        </div>
